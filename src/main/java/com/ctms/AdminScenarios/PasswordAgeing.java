...
public class PasswordAgeing {
	
	public PasswordAgeing() {
	...
	public void PasswrdAGNG() throws Exception {
		...
		WebElement Rolemngmt = GWait.Wait_GetElementByXpath("//nav/ul/li[1]/div/ul/li[7]/a");
		Rolemngmt.click();
		try {
